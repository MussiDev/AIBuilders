...
> **Cambios respecto de v1.1:** (1) se priorizó el alcance en un **MVP núcleo** (38 RF) separando el resto a **Fase 2 (post-MVP)** sin renumerar ni romper trazabilidad; (2) se dejó preparado el modelo de datos para **multi-moneda / bimonetarismo** a futuro sin migración destructiva, aunque sigue fuera de alcance del MVP.
...
Cada RF es atómico y verificable. Para acotar la primera entrega, los RF se clasifican en **MVP núcleo** y **Fase 2 (post-MVP)**. La numeración se mantiene estable (RF-01 a RF-48) para no romper la trazabilidad; los RF diferidos se marcan con **[Fase 2]**.

### 3.0 Priorización

**MVP núcleo (38 RF):** RF-01 a RF-15, RF-21 a RF-25, RF-28, RF-29, RF-31 a RF-38, RF-41 a RF-48.
...
Todos los RF (RF-01 a RF-48) tienen al menos un AC asociado. Los marcados **[F2]** corresponden a Fase 2 (post-MVP).

| RF | AC | RF | AC | RF | AC |
|---|---|---|---|---|---|
| RF-01 | AC-01 | RF-17 [F2] | AC-17 | RF-33 | AC-31 |
| RF-02 | AC-01, AC-02 | RF-18 [F2] | AC-18 | RF-34 | AC-32 |
| RF-03 | AC-03 | RF-19 [F2] | AC-18 | RF-35 | AC-33 |
| RF-04 | AC-04, AC-05 | RF-20 [F2] | AC-19 | RF-36 | AC-34 |
| RF-05 | AC-06 | RF-21 | AC-20 | RF-37 | AC-35 |
| RF-06 | AC-07 | RF-22 | AC-21 | RF-38 | AC-36 |
| RF-07 | AC-08 | RF-23 | AC-21 | RF-39 [F2] | AC-37 |
| RF-08 | AC-09 | RF-24 | AC-22 | RF-40 [F2] | AC-38 |
| RF-09 | AC-10 | RF-25 | AC-23 | RF-41 | AC-39 |
| RF-10 | AC-11 | RF-26 [F2] | AC-24 | RF-42 | AC-40 |
| RF-11 | AC-12 | RF-27 [F2] | AC-25 | RF-43 | AC-41 |
| RF-12 | AC-13 | RF-28 | AC-26 | RF-44 | AC-42 |
| RF-13 | AC-10 | RF-29 | AC-27 | RF-45 | AC-43 |
| RF-14 | AC-14 | RF-30 [F2] | AC-28 | RF-46 | AC-44 |
| RF-15 | AC-15 | RF-31 | AC-29 | RF-47 | AC-45 |
| RF-16 [F2] | AC-16 | RF-32 | AC-30 | RF-48 | AC-46 |
